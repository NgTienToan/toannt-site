...
import ICachedArticle from '../models/ICacheArticle';

const username = 'ngtientoan';
const blogURL = 'https://toannt.site/blog/';
const portfolioURL = 'https://toannt.site/portfolio/';
...
export const getAllArticles = async (websiteURL: string) => {
  const params = { username, per_page: 1000, 'api-key': 'DmeBLeGgvNTLrwipVEZN6FS4' };
  const headers = { 'api-key': process.env.DEVTO_APIKEY } as AxiosRequestHeaders;
