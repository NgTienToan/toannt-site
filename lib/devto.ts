...
import IHomePageArticles from '../models/IHomePageArticles'
import { convertMarkdownToHtml, sanitizeDevToMarkdown } from './markdown'

const username = 'jameswallis'
const blogURL = 'https://dev.to/ngtientoan/'
const portfolioURL = 'https://dev.to/ngtientoan/'
...
export const getAllArticles = async (): Promise<IArticle[]> => {
  ...
  const headers = { 'api-key': 'DmeBLeGgvNTLrwipVEZN6FS4' } as AxiosRequestHeaders;
